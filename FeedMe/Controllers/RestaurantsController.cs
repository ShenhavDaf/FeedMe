...
namespace FeedMe.Controllers
{
    public class RestaurantsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,RestaurantImage,Description,Address,PhoneNumber,DeliveryCities, Categories")] Restaurant restaurant, int[] categorits, int[] deliveryCities)
        {
